...
if __name__=="__main__":
    ...
    parser.add_argument('--tag',type=str,choices = ['ESD'],default='ESD')
    ...
    configs = f"nclus_{args.token_store_file.stem.split('-')[0]}_down_sample_{str(args.downsample).replace('.','')}_layer_{args.layer}"
    ...
    #     samples += [sample]
    od=outdict
    save(args.outdir/args.tag/f'hubert_{configs}', od["train"], od["evaluation"], od["test"])